...
describe.skipIf(process.env.VITEST_INTEGRATION !== 'true', 'AZURE_COSMOS_ENDPOINT not set — skipping in-process API server performance tests')('API Performance Tests', () => {
  let app: Application
