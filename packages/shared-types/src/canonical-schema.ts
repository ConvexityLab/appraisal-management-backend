...
/**
 * Summary of a single review program result, loaded from the review-results
 * Cosmos container and embedded at report-generation time.
 */
export interface CanonicalReviewProgramResult {
  programId: string;
  programVersion: string;
  evaluatedAt: string;
  overallRiskScore: number;
  computedDecision: 'Accept' | 'Conditional' | 'Reject';
  overrideDecision?: 'Accept' | 'Conditional' | 'Reject';
...
export interface CanonicalReportDocument {
  ...
  /** Review program results — loaded from the review-results container at report-generation time. */
  reviewProgramResults?: CanonicalReviewProgramResult[];
