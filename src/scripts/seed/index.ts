...
import { module as decompositionRulesModule } from './modules/decomposition-rules.js';
...
const ALL_MODULES: SeedModule[] = [
  ...
  decompositionRulesModule, // Phase 2.5 (must precede orders so fan-out has rules)
