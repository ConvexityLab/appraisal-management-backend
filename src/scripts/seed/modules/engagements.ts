      ...
      loans: [
        {
          ...
          loanNumber: 'FH-2026-88099',
          borrowerName: 'Anita Ramirez',
          borrowerEmail: 'a.ramirez@email.com',
          loanType: 'Conventional',
          property: {
            address: '921 Abrams Rd',
            city: 'Dallas',
            state: 'TX',
            zipCode: '75214',
            county: 'Dallas',
            ...
            squareFootage: 1120,
            yearBuilt: 2005,
            coordinates: { latitude: 32.8263, longitude: -96.7505 },
          },
          status: 'DELIVERED',
          products: [
            {
              ...
              productType: 'FULL_APPRAISAL',
              status: 'COMPLETED',
              instructions: '1073 condo form required.',
              fee: 600,
              dueDate: daysAgo(5),
